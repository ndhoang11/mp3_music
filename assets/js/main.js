...
const app = {
    ...
    songs :[
        ...
        },
        {
            name :  'Nắng ấm xa dần ' ,
            singer: ' sơn Tùng Mtp ',
            path: 'assets/mussic/NangAmXaDan-MTP-2697291.mp3',
            image :'assets/img/nangamxadan.jpg'
        },
        {
            name :  'Cơn mưa ngang qua  ' ,
            singer: ' sơn Tùng Mtp ',
            path: 'assets/mussic/ConMuaNgangQua-SonTungMTP-2944936.mp3',
            image :'assets/img/conmuangangqua.jpg'
        },
        {
            name :  'Em Của ngày hôm qua  ' ,
            singer: ' sơn Tùng Mtp ',
            path: 'assets/mussic/EmCuaNgayHomQua-SonTungMTP-2882720.mp3',
        ...
        },
        {
            name :  'Dreamer' ,
            singer: ' Jungkook ',
            path: 'assets/mussic/Dreamers-Jungkook-FIFA-World-Cup-2022.mp3',
            image :'assets/img/dreamer.jpg'
        },
        {
            name :  'Hayya Hayya' ,
            singer: ' World Cup ',
            path: 'assets/mussic/Hayya-Hayya-Better-Together-FIFA-World-Cup-2022.mp3',
            image :'assets/img/haya.jpeg'
        },
